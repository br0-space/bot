...
func (m Matcher) processTokens(requestMessage oldtelegram.RequestMessage, tokens []Token) {
...
func (m Matcher) processToken(requestMessage oldtelegram.RequestMessage, token Token) error {
	// Update the database
...
func (m Matcher) sendResponse(requestMessage oldtelegram.RequestMessage, token Token, newValue int) error {
	mode := "+-"
