...
func (m Matcher) sendRandomFortune(requestMessage oldtelegram.RequestMessage) error {
...
func (m Matcher) sendFortune(requestMessage oldtelegram.RequestMessage, file string) error {
...
func (m Matcher) sendFortuneResponse(requestMessage oldtelegram.RequestMessage, text string) error {
	responseText := text
...
func (m Matcher) sendHelpResponse(requestMessage oldtelegram.RequestMessage) error {
...
func (m Matcher) sendListResponse(requestMessage oldtelegram.RequestMessage) error {
