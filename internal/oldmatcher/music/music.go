...
func (m Matcher) processMatches(requestMessage oldtelegram.RequestMessage, matches []string) {
...
func (m Matcher) processMatch(requestMessage oldtelegram.RequestMessage, match string) error {
...
func (m Matcher) sendResponse(requestMessage oldtelegram.RequestMessage, songlinkEntry SonglinkEntry) error {
